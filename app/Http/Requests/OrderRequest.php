...
class OrderRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'PaymentStatusID' => 'required|exists:payment_statuses,PaymentStatusID',
            'OrderStatusID' => 'required|exists:order_statuses,OrderStatusID',
    ...
    public function messages()
    {
        return [
            ...
            'PaymentStatusID.required' => 'The payment status ID is required.',
            'PaymentStatusID.exists' => 'The selected payment status ID is invalid.',
            'OrderStatusID.required' => 'The order status ID is required.',
            'OrderStatusID.exists' => 'The selected order status ID is invalid.',
